...
export type StudentsTable_student = {
    readonly username: string;
    readonly firstName: string;
    readonly lastName: string;
    readonly gradeLevel: GradeLevel;
    readonly id: string;
    readonly " $refType": "StudentsTable_student";
};
export type StudentsTable_student$data = StudentsTable_student;
export type StudentsTable_student$key = {
    readonly " $data"?: StudentsTable_student$data;
...
(node as any).hash = 'a325d33613eab61a577f4c57719b5646';
export default node;
